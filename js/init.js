...
function preloadInit () {
    ...
    game.load.image('extra level', 'assets/imgs/buttons/extraLevel.png');
...
function createInit() {
    ...
    btnStart = game.add.button(btnposX - 150, btnposY, 'playButton', onStartButtonPressed);
    ...
    // Part D BUTTON
    btnExtraLevel = game.add.button(btnposX + 150, btnposY,
        'extra level', onExtraLevelButtonPressed);
    btnExtraLevel.anchor.setTo(0.5, 0.5);
    btnExtraLevel.scale.setTo(0.75);
    btnExtraLevel.events.onInputOver.add(mouseOver, this);
    btnExtraLevel.events.onInputOut.add(mouseOut, this);
...
function onExtraLevelButtonPressed(){
